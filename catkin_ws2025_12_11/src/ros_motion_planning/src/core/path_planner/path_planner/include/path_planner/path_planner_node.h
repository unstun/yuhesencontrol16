...
#include <nav_msgs/OccupancyGrid.h>  // 新增
...
protected:
  ...
  // === 新增：订阅静态 OccupancyGrid，给 Hybrid A* 三圆判障用 ===
  ros::Subscriber static_map_sub_;  // ★ 新增：静态地图订阅者
  void staticMapCallback(const nav_msgs::OccupancyGrid::ConstPtr& msg);  // ★ 新增：回调函数
